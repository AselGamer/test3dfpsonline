...
namespace GetGunsScript
{
    public class GetGuns
    {
        ...
        public void FetchGuns()
        {
            ...
            gunsDict.Add(1, new Gun(1, "SPAS-12", Resources.Load<GameObject>("Prefabs/Guns/hl2_shotgun/hl2_shotgun"), Resources.Load<GameObject>("Prefabs/Guns/hl2_shotgun/hl2_shotgun_viewmodel"), Resources.Load<GameObject>("Prefabs/Guns/hl2_shotgun/hl2_shotgun_client")));
        }
